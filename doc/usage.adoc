...
[source,bash]
----
osivalidator --data data/20240221T141700Z_sv_312_10_one_moving_object.osi -p
----
...
osivalidator --data data/20240221T141700Z_sv_312_10_one_moving_object.osi --rules rules -p
----
