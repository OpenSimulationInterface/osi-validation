...
class TestRefers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.linked_hvid1 = LinkedProtoField(hvid1, name="host_vehicle_id", parent=linked_gt1)
        ...
        self.linked_hvid2 = LinkedProtoField(hvid1, name="host_vehicle_id", parent=linked_gt2)
